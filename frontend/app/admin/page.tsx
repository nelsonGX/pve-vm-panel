  ...
  return (
    <div className="animate-fade-in">
      ...
      {codes.length === 0 ? (
        ...
        <div className="border-b-4 border-r-4 border-zinc-600 bg-zinc-600 w-full pixel-panel-outer">
          <div className="border-4 border-zinc-400 bg-zinc-900/85 w-full pixel-panel-inner overflow-x-auto">
    ...
    return (
      <div className="flex flex-1 items-center justify-center">
        <div className="border-b-4 border-r-4 border-red-800 bg-red-800 pixel-panel-outer">
          <div className="border-4 border-red-400 bg-zinc-900 pixel-panel-inner p-8 text-center">
      ...
      <div className="animate-fade-in stagger-1 mb-6 flex gap-2 border-b-2 border-zinc-700 pb-2">
        {TABS.map((tab) => (
          <button
            ...
            className={`px-4 py-2 text-sm font-medium transition-all duration-75 border-b-4 border-r-4 ${
              activeTab === tab.id
