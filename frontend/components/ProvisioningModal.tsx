...
const STEP_ICONS: Record<StepStatus, React.ReactNode> = {
  ...
  loading: (
    ...
    <span className="flex h-5 w-5 items-center justify-center bg-emerald-900 text-emerald-400">
      <Check className="h-3.5 w-3.5" />
    </span>
  ),
  error: (
    <span className="flex h-5 w-5 items-center justify-center bg-red-900 text-red-400">
